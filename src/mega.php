...
define('OVERWORLD_MAPS', [
    ...
    // 2 zoom
    186, 181, 176, 196, 
    202, 207, 233, 253, 259, 264, 267, 282,
    300, 305, 311, 321, 393,
    499, 523, 531,
    ...
    447, 448, 451, 453, 455, 456, 458, 459, 460, 461, 462, 463, 464,
    
    469, 474, 479, 484, 490, 497,
    521, 529,
]);
define('END_MAPS', [
    // 4 zoom
...
$banners =  [];
if ($end) {
    $banners = $converter->generate_tiles(END_MAPS, -2112, -4160, 3, 4);
} else {
